...
class NER(object):
    ...
    def len_word(self):
        return self.current_token!= None and len(self.current_token)>=3
    
    def following_title(self):
        return self.last_token in ["Mr.", "Mrs.", "Dr.", "Prof.","Miss"]
    ...
    def __init__(self, training_file, test_file, model_file, stochastic_gradient_descent,
        ...
        self.features = [
            ...
            NER.FeatureFunction(self.following_title),
            #NER.FeatureFunction(self.len_word)
        ]
